...
import 'package:teelead/Domain/models/commonModels/edit_profile_model.dart';
...
class EditProfile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      ...
      child: const subEditProfile(),
    );
  }
}

class subEditProfile extends StatelessWidget {
  const subEditProfile({super.key});
          ...
          ? Container(
              ...
              decoration: BoxDecoration(
                  ...
                  image: DecorationImage(
                      image: FileImage(model.file!), fit: BoxFit.cover)),
            )
