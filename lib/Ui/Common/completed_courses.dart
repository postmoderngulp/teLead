...
import 'package:teelead/Domain/models/commonModels/completed_courses_model.dart';
...
class CompletedCourses extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      create: (context) => CompletedCoursesModel(),
      child: const subCompletedCourses(),
    );
  }
}

class subCompletedCourses extends StatelessWidget {
  const subCompletedCourses({super.key});
...
class CertificateButton extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final model = context.read<CompletedCoursesModel>();
    return Center(
      child: GestureDetector(
        onTap: () => model.goToCertificate(context),
        child: SvgPicture.asset(
          "assets/image/certificate_button.svg",
          width: 94.w,
          height: 60.h,
        ),
      ),
...
class enrollButton extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final model = context.watch<CompletedCoursesModel>();
    return Center(
      child: SizedBox(
          width: 250.w,
          height: 60.h,
