...
class verifyForgotPassword extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(create: (context)=> verifyForgotPasswordModel(), child: const subVerifyForgotPassword(),);
  }
}
          ...
          children: [
            ...
            Row(
              children: [
                ...
                SizedBox(width: 10.w,),
                Text("Forgot Password",style: textStyle.titleStyle,),

              ],
            ),
            SizedBox(height: 124.h,),

            Center(child: Text("Code has been Send to ( +1 ) ***-***-*529",style: textStyle.subMulishStyle,)),
            const resendCode(),
            const verifyButton(),
